...
* **Contenedores y Modales con Scroll Interno**: Si la página no realiza scroll en la ventana global (habitual en SPAs, paneles administrativos y diálogos modales emergentes) o cuenta con un elemento principal con desplazamiento propio, la extensión detecta automáticamente el contenedor, ejecuta el scroll interno y realiza un ensamblado adaptativo que captura la información íntegra sin cortes ni duplicidades.
